...
const NL: Record<string, string> = {
  ...
  "The editor sends from": "De editor verzendt vanaf",
  ...
  Network: "Netwerk",
  "Recorded telegrams": "Opgenomen telegrammen",
...
const DE: Record<string, string> = {
  ...
  "The editor sends from": "Der Editor sendet von",
  ...
  Network: "Netzwerk",
  "Recorded telegrams": "Aufgezeichnete Telegramme",
